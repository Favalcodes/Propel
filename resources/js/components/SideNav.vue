<template>
    <aside class="bg-secondary">
        <div class="side-menu">
            <a class="nav-button" activeClass="active-nav" href="#">
            ...
            <a class="nav-button" activeClass="active-nav" href="#">
                <span class="material-icons">
                    <Icons name="financial" />
                </span>
                <span class="text">Financial Service</span>
            </a>
            <a class="nav-button" activeClass="active-nav" href="#">
                <span class="material-icons">
                    <Icons name="discount" />
                </span>
                <span class="text">Discount and Deals</span>
            </a>
            <a class="nav-button" activeClass="active-nav" href="#">
                <span class="material-icons">
                    <Icons name="opportunity" />
                </span>
            ...
            <a class="nav-button" activeClass="active-nav" href="#">
                ...
                <span class="text">Community Wall</span>
            </a>
        </div>
        ...
        <a class="nav-button" activeClass="active-nav" href="#">
            ...
            <span class="text text-gray-400">Powered by Propel</span>
